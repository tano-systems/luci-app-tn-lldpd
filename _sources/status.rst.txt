...
Переключение между режимами производится однократным нажатием на любом месте строки.
...
В компактном режиме отображения, в столбцах таблицы отображаются следующие
...
В расширенном режиме отображения информации в столбцах таблицы
...
В компактном режиме отображения, в столбцах таблицы статистики интерфейсов
...
В расширенном режиме отображения информации в столбце "Локальный интерфейс"
...
.. list-table::
   ...
   * - Тип ID порта
     - Тип идентификатора порта локального интерфейса.
       Как правило, одно из следующих значений:
